...
public class MNISTReader {
  ...
  public static void main(String[] args) throws IOException {
    ...
    DataInputStream labels = new DataInputStream(new FileInputStream(label_file));
    DataInputStream images = new DataInputStream(new FileInputStream(image_file));
